...
// Creamos el objeto db que será nuestra nuestra base de datos y le añadimos métodos accesores (getter y setter) en la propiedad users.
...
const db = { // creamos el objeto db
    get users() { // creamos el getter en la propiedad users. Podemos llamar al getter usando, por ejemplo: const users = db.users
        ...
        return JSON.parse(users) // Traduce el objeto JSON (con el método parse) y lo devuelve
    },
...
// Exportamos db para poder usarlo en otros archivos de js
